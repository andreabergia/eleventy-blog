...
Where [`CallFrame::invoke_method`](https://github.com/andreabergia/rjvm/blob/5d96abd36bc7608fcfbb60fbcd4195818a59b60e/vm/src/call_frame.rs#L784) is as follows (I am omitting an ugly hack here; you can look it up on GitHub if you want 😅):
...
We are nearing the end of this (long) series! 🎉 The next part will cover how objects and arrays are implemented in RJVM and some more details about the garbage collections that weren't covered in [part 1]( {% ref "2023-07-12-rjvm-1.markdown" %} ).
