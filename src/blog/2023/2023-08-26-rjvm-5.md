...
In this post, I will discuss how [RJVM](https://github.com/andreabergia/rjvm) executes the Java bytecode. We will discuss various families of instructions, but we will leave method invocations and exception handling for the next part, because this post is already long enough. 😅
...
As an aside, notice how _nice_ `MethodCallResult` is, using the power of [sum types](https://en.wikipedia.org/wiki/Algebraic_data_type) of Rust! 🤩
